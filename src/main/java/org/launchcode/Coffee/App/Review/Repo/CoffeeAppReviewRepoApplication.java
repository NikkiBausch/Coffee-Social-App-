...
public class CoffeeAppReviewRepoApplication {
	...
	//NewReview Review1 = new NewReview("03/20/2020", "Coffee Pirates", BeverageName.COLDBREW, Atmosphere.ARTISTIC, OverallRating.FIVESTARS, "This is my favorite third wave cafe in all of Vienna!!!" );
	//NewReview Review2 = new NewReview("10/10/2019", "Jonas Reindl", BeverageName.LATTE, Atmosphere.OTHER, OverallRating.ONESTAR, "This place offered me a job after I interviewed with them,+" +
	...
	//NewReview Review3 = new NewReview("03/24/2020", "DirtWater", BeverageName.CAPPUCCINO, Atmosphere.INDUSTRIAL, OverallRating.FOURSTARS, "They have lots of non-dairy milk options and great vegan pastries, but the website needs to be updated+" +
	...
	//NewReview Review4 = new NewReview("02/11/2020", "Phil", BeverageName.LATTEMACCHIATO, Atmosphere.COZY, OverallRating.FOURSTARS, "This is a bookstore, cafe, and late-night club all-in-one that is open all night. I like to go here to study in early evening +" +
	...
	//NewReview Review5 = new NewReview("10/31/2019", "Brass Monkey", BeverageName.ESPRESSOSHOTS, Atmosphere.OTHER, OverallRating.FOURSTARS, "I love going here on Halloween because every year they have different" +
